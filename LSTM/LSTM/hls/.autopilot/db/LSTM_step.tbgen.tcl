...
set C_modelArgMapList {[ 
	{ "Name" : "W_f", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "x1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ x1 sc_in sc_lv 3 signal 13 } 
	{ h_address0 sc_out sc_lv 5 signal 14 } 
	{ h_ce0 sc_out sc_logic 1 signal 14 } 
	{ h_we0 sc_out sc_logic 1 signal 14 } 
	{ h_d0 sc_out sc_lv 32 signal 14 } 
	{ h_q0 sc_in sc_lv 32 signal 14 } 
	{ h_address1 sc_out sc_lv 5 signal 14 } 
	{ h_ce1 sc_out sc_logic 1 signal 14 } 
	{ h_q1 sc_in sc_lv 32 signal 14 } 
	{ c_address0 sc_out sc_lv 5 signal 15 } 
	{ c_ce0 sc_out sc_logic 1 signal 15 } 
	{ c_we0 sc_out sc_logic 1 signal 15 } 
	{ c_d0 sc_out sc_lv 32 signal 15 } 
	{ c_address1 sc_out sc_lv 5 signal 15 } 
	{ c_ce1 sc_out sc_logic 1 signal 15 } 
	{ c_q1 sc_in sc_lv 32 signal 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x1", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "x1", "role": "default" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1012", "Max" : "1012"}
]}
