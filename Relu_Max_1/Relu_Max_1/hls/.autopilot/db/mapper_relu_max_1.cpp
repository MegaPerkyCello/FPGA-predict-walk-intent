...
using hls::sim::Byte;
extern "C" void relu_max_1(Byte<4>*, Byte<4>*);
extern "C" void apatb_relu_max_1_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  relu_max_1(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
