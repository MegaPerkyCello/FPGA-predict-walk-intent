...
set name relu_max_1_fcmp_32ns_32ns_1_2_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_r \
    op interface \
    ports { output_r_address0 { O 8 vector } output_r_ce0 { O 1 bit } output_r_we0 { O 1 bit } output_r_d0 { O 32 vector } } \
} "
} else {
...
set InstName relu_max_1_flow_control_loop_pipe_U
set CompName relu_max_1_flow_control_loop_pipe
