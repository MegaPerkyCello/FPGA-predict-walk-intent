...
HLS_SOURCES = ../../../../relu_max_1_TB.cpp ../../../../relu_max_1.cpp
...
$(ObjDir)/relu_max_1_TB.o: ../../../../relu_max_1_TB.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../relu_max_1_TB.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/relu_max_1_TB.d

$(ObjDir)/relu_max_1.o: ../../../../relu_max_1.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../relu_max_1.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
