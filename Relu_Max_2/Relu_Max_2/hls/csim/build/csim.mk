...
HLS_SOURCES = ../../../../relu_max_2_TB.cpp ../../../../relu_max_2.cpp
...
$(ObjDir)/relu_max_2_TB.o: ../../../../relu_max_2_TB.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../relu_max_2_TB.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/relu_max_2_TB.d

$(ObjDir)/relu_max_2.o: ../../../../relu_max_2.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../relu_max_2.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
