...
set cdfgNum 2
set C_modelName {conv1_1d}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict inputs { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
dict set ap_memory_interface_dict weights { MEM_WIDTH 32 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict bias { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ inputs int 32 regular {array 64 { 1 1 } 1 1 }  }
	{ outputs int 32 regular {array 512 { 0 3 } 0 1 }  }
	{ weights int 32 regular {array 160 { 1 1 } 1 1 }  }
	{ bias int 32 regular {array 16 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ inputs_address0 sc_out sc_lv 6 signal 0 } 
	{ inputs_ce0 sc_out sc_logic 1 signal 0 } 
	{ inputs_q0 sc_in sc_lv 32 signal 0 } 
	{ inputs_address1 sc_out sc_lv 6 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inputs_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "inputs", "role": "address0" }} , 
 	...
 	{ "name": "inputs_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "inputs", "role": "address1" }} , 
...
set ArgLastReadFirstWriteLatency {
	conv1_1d {
		inputs {Type I LastRead 5 FirstWrite -1}
		outputs {Type O LastRead -1 FirstWrite 61}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2618", "Max" : "2618"}
	, {"Name" : "Interval", "Min" : "2619", "Max" : "2619"}
]}
...
set Spec2ImplPortList { 
	inputs { ap_memory {  { inputs_address0 mem_address 1 6 }  { inputs_ce0 mem_ce 1 1 }  { inputs_q0 mem_dout 0 32 }  { inputs_address1 MemPortADDR2 1 6 }  { inputs_ce1 MemPortCE2 1 1 }  { inputs_q1 MemPortDOUT2 0 32 } } }
	outputs { ap_memory {  { outputs_address0 mem_address 1 9 }  { outputs_ce0 mem_ce 1 1 }  { outputs_we0 mem_we 1 1 }  { outputs_d0 mem_din 1 32 } } }
	weights { ap_memory {  { weights_address0 mem_address 1 8 }  { weights_ce0 mem_ce 1 1 }  { weights_q0 mem_dout 0 32 }  { weights_address1 MemPortADDR2 1 8 }  { weights_ce1 MemPortCE2 1 1 }  { weights_q1 MemPortDOUT2 0 32 } } }
