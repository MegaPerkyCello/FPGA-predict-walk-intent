...
using hls::sim::Byte;
extern "C" void conv1_1d(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_conv1_1d_hw(volatile void * __xlx_apatb_param_inputs, volatile void * __xlx_apatb_param_outputs, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias) {
...
__xlx_inputs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_inputs)[i]);
  ...
  int __xlx_size_param_inputs = 64;
...
__xlx_weights__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 160;
...
__xlx_bias__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_bias)[i]);
  ...
  // DUT call
  conv1_1d(__xlx_inputs__tmp_vec.data(), __xlx_outputs__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_bias__tmp_vec.data());
