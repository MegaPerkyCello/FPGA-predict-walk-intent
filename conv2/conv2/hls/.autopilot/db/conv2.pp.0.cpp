...
# 1 "C:/Users/cocol/Ruby_Proj/workspace/header\\layer_dims.h" 1
...
# 16 "C:/Users/cocol/Ruby_Proj/workspace/header\\layer_dims.h"
...
constexpr int LSTM_T = P2_OUT_LEN;
constexpr int LSTM_IN_DIM = P2_C;
constexpr int LSTM_HIDDEN = 32;
# 4 "conv2.cpp" 2



__attribute__((sdx_kernel("conv2_1d", 0))) void conv2_1d(const data_t inputs[C2_IC][C2_IN_LEN],
              data_t outputs[C2_OC][C2_OUT_LEN],
              const data_t weights[C2_OC][C2_IC][C2_K],
              const data_t bias[C2_OC]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=conv2_1d
# 10 "conv2.cpp"
    ...
    VITIS_LOOP_16_1: for (int oc = 0; oc < C2_OC; ++oc) {
        VITIS_LOOP_17_2: for (int o = 0; o < C2_OUT_LEN; ++o) {
            data_t acc = bias[oc];

            VITIS_LOOP_20_3: for (int ic = 0; ic < C2_IC; ++ic) {
                VITIS_LOOP_21_4: for (int k = 0; k < C2_K; ++k) {
