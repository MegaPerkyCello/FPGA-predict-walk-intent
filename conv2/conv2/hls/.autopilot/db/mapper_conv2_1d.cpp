...
using hls::sim::Byte;
extern "C" void conv2_1d(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_conv2_1d_hw(volatile void * __xlx_apatb_param_inputs, volatile void * __xlx_apatb_param_outputs, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias) {
...
__xlx_inputs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_inputs)[i]);
  ...
  int __xlx_size_param_inputs = 256;
  int __xlx_offset_param_inputs = 0;
  int __xlx_offset_byte_param_inputs = 0*4;
  // Collect __xlx_outputs__tmp_vec
std::vector<Byte<4>> __xlx_outputs__tmp_vec;
for (size_t i = 0; i < 512; ++i){
__xlx_outputs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_outputs)[i]);
}
  int __xlx_size_param_outputs = 512;
  int __xlx_offset_param_outputs = 0;
  int __xlx_offset_byte_param_outputs = 0*4;
...
__xlx_weights__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 1536;
...
__xlx_bias__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_bias)[i]);
  ...
  int __xlx_size_param_bias = 32;
  int __xlx_offset_param_bias = 0;
  int __xlx_offset_byte_param_bias = 0*4;
  // DUT call
  conv2_1d(__xlx_inputs__tmp_vec.data(), __xlx_outputs__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_bias__tmp_vec.data());
...
((Byte<4>*)__xlx_apatb_param_outputs)[i] = __xlx_outputs__tmp_vec[__xlx_offset_param_outputs+i];
}
