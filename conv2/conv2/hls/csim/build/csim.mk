...
HLS_SOURCES = ../../../../conv2_TB.cpp ../../../../conv2.cpp
...
$(ObjDir)/conv2_TB.o: ../../../../conv2_TB.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../conv2_TB.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/conv2_TB.d

$(ObjDir)/conv2.o: ../../../../conv2.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../conv2.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
